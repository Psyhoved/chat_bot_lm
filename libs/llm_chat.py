...
def check_question(message: str) -> str:
    ...
    operator_words = [
        ...
        "кислое", "испорчено", "тухлое", "невкусно","невкусное", "камень", "стекло", "постороннее", "посторонний","пластик", "пленка",
        "мошка", "муха", "таракан", "жук", "живность", "насекомое", "кость", "нитка", "сломан зуб",  "волос", "дорого",
        "прокуратура", "суд", "твердый предмет", "сухо", "переварено", "переварен", "сырое", "пересолено", "пересолен",
        "непропеченная", "отравление", "плохое самочувствие", "несвежий", "обслуживание", "сервис", "нагрубили",
        "отказали", "плесень", "плесенью", "грязно", "грязь", "перепутали", "просрок", "возврат", "денежные средства", "воняет", "задержка",
        "клиентоориентированность", "недолив", "опоздание", "долго", "ожидание", "диарея", "отвратительные", "отвратительно",
        "ужасный", "ужасное", "ужасная", "плохо приготовлено", "обматерили"
    ]
